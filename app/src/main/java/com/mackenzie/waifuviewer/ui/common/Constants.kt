...
class Constants {
    companion object {
        const val SERVER_MODE = "server_mode"
        const val LOADED_SELECTOR = "selector_mode"
        const val WORK_MODE = "work_mode"
        const val IS_NSFW_WAIFU = "nsfw"
        const val IS_FAVORITE_WAIFU = "favorite_waifu"
        const val IS_GIF_WAIFU = "gif"
        const val IS_LANDS_WAIFU = "lands"
        const val IS_WAIFU_GPT = "waifu_gpt"
        const val IS_WAIFU_GEMINI = "waifu_gemini"
        const val CATEGORY_TAG_WAIFU = "tag"
